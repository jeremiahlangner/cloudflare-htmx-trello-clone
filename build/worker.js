...
`};function s(n,...t){return String.raw({raw:n},...t)}async function g(n){return new Response(n,{headers:{"content-type":"text/html;charset=UTF-8"}})}async function a(n){return typeof n!="string"&&(n=JSON.stringify(n)),new Response(n,{headers:{"content-type":"application/json"}})}var u,h=s(u||(u=l([`
  <!doctype html>
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
...
`};function k(){return new Response(f.sw,{headers:{"content-type":"text/javascript;charset=UTF-8"}})}var b=k;async function m(n){let t='[{"name":"To Do","id":"1","cards":[{"id":"2","label":"Second Card","list":"1"},{"id":"1","label":"First Card","list":"1"},{"label":"Third Card","id":"0bfdc1222adc9","list":"1"}]},{"name":"Doing","id":"2","cards":[{"id":"3","label":"First Card","list":2},{"id":"4","label":"Second Card","list":"2"}]}]';await n.env.TrelloLists.get("lists")!=t&&await n.env.TrelloLists.put("lists",'[{"name":"To Do","id":"1","cards":[{"id":"2","label":"Second Card","list":"1"},{"id":"1","label":"First Card","list":"1"},{"label":"Third Card","id":"0bfdc1222adc9","list":"1"}]},{"name":"Doing","id":"2","cards":[{"id":"3","label":"First Card","list":2},{"id":"4","label":"Second Card","list":"2"}]}]')}async function o(n){let{route:t,env:e}=n,r=t.pathname.groups.key;return await e.TrelloLists.get(r)}var B={async fetch(n,t,e){return new c([["/",async i=>g(h)],["/sw.js",b],["/db/:key",async i=>a(await o(i))],["/db/:key",async i=>{let w=await i.request.json();return t.TrelloLists.put(i.route.pathname.groups.key,JSON.stringify(w)),a(await o(i))},"POST"]]).handle({request:n,env:t,ctx:e})},async scheduled(n,t,e){return m({event:n,env:t,ctx:e})}};export{B as default};
