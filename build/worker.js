...
`};function a(t,...n){return String.raw({raw:t},...n)}function $(t){let n="";do n=Math.random().toString(16).substring(2,15);while(t[n]);return n}async function d(t){return new Response(nn(t),{headers:{"content-type":"text/html;charset=UTF-8"}})}function nn(t){return t=t.replace(/(\r\n|\n|\r)/gm,"").replace(/\s+/g," ").trim(),t}var J;function _(t){return a(J||(J=k([`
    <!doctype html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
...
`;function tn(t){let{list:n}=t;return a`
    <button
  ...
  `}var S=tn;function en(t){let{list:n}=t;return a`
...
`,T=rn;function an(t){let{list:n,card:e}=t;return a`
    <div
      class="card"
      id="card-${e.id}"
      tabindex="0"
  ...
  `}var y=an;function sn(t){let n=a``;for(let e of t.cards)n+=a`${y({list:t,card:e})}`;return n}function on(t){let{lists:n}=t,e=a``;for(let r of n)e+=a`
    ...
    `;return e+=a` <div class="add-list">${T}</div> `,e}var f=on;var P;function dn(t){return d(_({template:a(P||(P=k([`
        <div class="app">
        ...
        <\/script>
      `])),f(t))}))}var A=dn;function ln(){return d(a`
  ...
  `)}var M=ln;function cn(t){let{list:n,card:e}=t;return a`
...
\`};function o(t,...n){return String.raw({raw:t},...n)}function N(t){let n="";do n=Math.random().toString(16).substring(2,15);while(t[n]);return n}async function d(t){return new Response(en(t),{headers:{"content-type":"text/html;charset=UTF-8"}})}function en(t){return t=t.replace(/(\\r\\n|\\n|\\r)/gm,"").replace(/\\s+/g," ").trim(),t}var _;function A(t){return o(_||(_=k([\`
    <!doctype html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
...
\`,T=sn;function on(t){let{list:n,card:e}=t;return o\`
  ...
  \`}var y=on;function dn(t){let n=o\`\`;for(let e of t.cards)n+=o\`\${y({list:t,card:e})}\`;return n}function ln(t){let{lists:n}=t,e=o\`\`;for(let r of n)e+=o\`
    ...
    \`;return e+=o\` <div class="add-list">\${T}</div> \`,e}var f=ln;var M;function cn(t){return d(A({template:o(M||(M=k([\`
        <div class="app">
          <div class="header">htmx Trello Clone</div>
        ...
        <\\/script>
      \`])),f(t))}))}var U=cn;function pn(){return d(o\`
    <div id="add-list" class="add-list-editor">
      <form hx-post="/lists" hx-target="#board">
        <div class="list-title-edit">
          <input
...
\`};function hn(){return new Response(q.sw,{headers:{"content-type":"text/javascript;charset=UTF-8"}})}var D=hn;async function B(t){let{env:n}=t;return{lists:JSON.parse(await n.TrelloLists.get("lists"))}}async function W(t){let{route:n,env:e}=t,{list_id:r}=n.pathname.groups,a=JSON.parse(await e.TrelloLists.get("lists"));return a=a.filter(i=>i.id!==r),await e.TrelloLists.put("lists",JSON.stringify(a)),{lists:a}}async function F(t){let{request:n,env:e,route:r}=t,{list_id:a,id:i}=r.pathname.groups,s=new URLSearchParams(await n.text()),l=Object.fromEntries(s),{label:c}=l,m=JSON.parse(await e.TrelloLists.get("lists")),b=m.find(x=>x.id===a),g=b.cards.find(x=>x.id===i);return g.label=c,await e.TrelloLists.put("lists",JSON.stringify(m)),{list:b,card:g}}async function V(t){let{env:n,route:e}=t,{list_id:r,id:a}=e.pathname.groups,s=JSON.parse(await n.TrelloLists.get("lists")).find(c=>c.id===r),l=s.cards.find(c=>c.id===a);return{list:s,card:l}}async function X(t){let{env:n,route:e}=t,{list_id:r,id:a}=e.pathname.groups,i=JSON.parse(await n.TrelloLists.get("lists")),s=i.find(l=>l.id===r);s.cards=s.cards.filter(l=>l.id!==a),await n.TrelloLists.put("lists",JSON.stringify(i))}async function G(t){let{request:n,env:e}=t,r=new URLSearchParams(await n.text()),a=Object.fromEntries(r),{name:i}=a,s=JSON.parse(await e.TrelloLists.get("lists"));return s.push({name:i,id:N({}),cards:[]}),await e.TrelloLists.put("lists",JSON.stringify(s)),{lists:s}}async function K(t){let{request:n,route:e,env:r}=t,a=JSON.parse(await r.TrelloLists.get("lists")),{list_id:i}=e.pathname.groups,s=new URLSearchParams(await n.text()),c=Object.fromEntries(s)["label-"+i],m=a.find(g=>g.id===i),b={label:c,id:N({}),list:i};return m.cards.push(b),await r.TrelloLists.put("lists",JSON.stringify(a)),{lists:a}}async function Q(t){let{env:n,route:e}=t,r=e.pathname.groups.id;return{list:JSON.parse(await n.TrelloLists.get("lists")).find(s=>s.id===r)}}async function Y(t){let{env:n,route:e}=t,{list_id:r,id:a}=e.pathname.groups,s=JSON.parse(await n.TrelloLists.get("lists")).find(c=>c.id===r),l=s.cards.find(c=>c.id===a);return{list:s,card:l}}async function Z(t){let{request:n,env:e}=t,r=new URLSearchParams(await n.text()),a=Object.fromEntries(r),{from:i,to:s,movedCard:l,index:c,prevIndex:m}=a,[,b]=i.split("-"),[,g]=s.split("-"),x=l.replace("card-",""),p=JSON.parse(await e.TrelloLists.get("lists"));try{if(i==="board"&&s==="board"){let u=p[m];p=p.filter(w=>w.id!==u.id),p.splice(c,0,u),await e.TrelloLists.put("lists",JSON.stringify(p))}else{let u=JSON.parse(JSON.stringify(p)),w=u.find(h=>h.id===b),C=w.cards.find(h=>h.id==x);C.list=g,w.cards=w.cards.filter(h=>h.id!=x),u.find(h=>h.id==g).cards.splice(Number(c),0,C),p=u,await e.TrelloLists.put("lists",JSON.stringify(p))}}catch(u){console.error(u)}return{lists:p}}var fn="cacheName",mn="0",$;$||($=new J("trelloClone",$));self.addEventListener("install",t=>{t.waitUntil(caches.open(mn+fn).then(n=>n.addAll(["/"])))});self.addEventListener("activate",t=>{});self.addEventListener("fetch",t=>t.respondWith((async()=>{let n=t.request,e={TrelloList:$},r=void 0;return new E([["/",async i=>U(await B(i))],["/sw.js",D],["/lists",async i=>d(f(await G(i))),"POST"],["/lists/add",R],["/lists/cancel",()=>d(T)],["/lists/:list_id",async i=>d(f(await W(i))),"DELETE"],["/cards/move",async i=>d(f(await Z(i))),"POST"],["/cards/new/:list_id",async i=>d(f(await K(i))),"POST"],["/cards/cancel/:id",async i=>d(S(await Q(i)))],["/cards/edit/:list_id/:id",async i=>d(I(await Y(i)))],["/cards/:list_id/:id",async i=>d(y(await F(i))),"PUT"],["/cards/:list_id/:id",async i=>(await X(i),d("")),"DELETE"],["/cards/cancel-edit/:list_id/:id",async i=>d(y(await V(i)))]]).handle({request:n,env:e,ctx:r})})()));
`};function un(){return new Response(U.sw,{headers:{"content-type":"text/javascript;charset=UTF-8"}})}var R=un;async function I(t){let n='[{"name":"To Do","id":"1","cards":[{"id":"2","label":"Second Card","list":"1"},{"id":"1","label":"First Card","list":"1"},{"label":"Third Card","id":"0bfdc1222adc9","list":"1"}]},{"name":"Doing","id":"2","cards":[{"id":"3","label":"First Card","list":2},{"id":"4","label":"Second Card","list":"2"}]}]';await t.env.TrelloLists.get("lists")!=n&&await t.env.TrelloLists.put("lists",'[{"name":"To Do","id":"1","cards":[{"id":"2","label":"Second Card","list":"1"},{"id":"1","label":"First Card","list":"1"},{"label":"Third Card","id":"0bfdc1222adc9","list":"1"}]},{"name":"Doing","id":"2","cards":[{"id":"3","label":"First Card","list":2},{"id":"4","label":"Second Card","list":"2"}]}]')}async function q(t){let{env:n}=t;return{lists:JSON.parse(await n.TrelloLists.get("lists"))}}async function D(t){let{route:n,env:e}=t,{list_id:r}=n.pathname.groups,i=JSON.parse(await e.TrelloLists.get("lists"));return i=i.filter(o=>o.id!==r),await e.TrelloLists.put("lists",JSON.stringify(i)),{lists:i}}async function B(t){let{request:n,env:e,route:r}=t,{list_id:i,id:o}=r.pathname.groups,s=new URLSearchParams(await n.text()),c=Object.fromEntries(s),{label:l}=c,b=JSON.parse(await e.TrelloLists.get("lists")),m=b.find(x=>x.id===i),h=m.cards.find(x=>x.id===o);return h.label=l,await e.TrelloLists.put("lists",JSON.stringify(b)),{list:m,card:h}}async function F(t){let{env:n,route:e}=t,{list_id:r,id:i}=e.pathname.groups,s=JSON.parse(await n.TrelloLists.get("lists")).find(l=>l.id===r),c=s.cards.find(l=>l.id===i);return{list:s,card:c}}async function W(t){let{env:n,route:e}=t,{list_id:r,id:i}=e.pathname.groups,o=JSON.parse(await n.TrelloLists.get("lists")),s=o.find(c=>c.id===r);s.cards=s.cards.filter(c=>c.id!==i),await n.TrelloLists.put("lists",JSON.stringify(o))}async function V(t){let{request:n,env:e}=t,r=new URLSearchParams(await n.text()),i=Object.fromEntries(r),{name:o}=i,s=JSON.parse(await e.TrelloLists.get("lists"));return s.push({name:o,id:$({}),cards:[]}),await e.TrelloLists.put("lists",JSON.stringify(s)),{lists:s}}async function X(t){let{request:n,route:e,env:r}=t,i=JSON.parse(await r.TrelloLists.get("lists")),{list_id:o}=e.pathname.groups,s=new URLSearchParams(await n.text()),l=Object.fromEntries(s)["label-"+o],b=i.find(h=>h.id===o),m={label:l,id:$({}),list:o};return b.cards.push(m),await r.TrelloLists.put("lists",JSON.stringify(i)),{lists:i}}async function G(t){let{env:n,route:e}=t,r=e.pathname.groups.id;return{list:JSON.parse(await n.TrelloLists.get("lists")).find(s=>s.id===r)}}async function K(t){let{env:n,route:e}=t,{list_id:r,id:i}=e.pathname.groups,s=JSON.parse(await n.TrelloLists.get("lists")).find(l=>l.id===r),c=s.cards.find(l=>l.id===i);return{list:s,card:c}}async function Q(t){let{request:n,env:e}=t,r=new URLSearchParams(await n.text()),i=Object.fromEntries(r),{from:o,to:s,movedCard:c,index:l,prevIndex:b}=i,[,m]=o.split("-"),[,h]=s.split("-"),x=c.replace("card-",""),p=JSON.parse(await e.TrelloLists.get("lists"));try{if(o==="board"&&s==="board"){let u=p[b];p=p.filter(w=>w.id!==u.id),p.splice(l,0,u),await e.TrelloLists.put("lists",JSON.stringify(p))}else{let u=JSON.parse(JSON.stringify(p)),w=u.find(g=>g.id===m),O=w.cards.find(g=>g.id==x);O.list=h,w.cards=w.cards.filter(g=>g.id!=x),u.find(g=>g.id==h).cards.splice(Number(l),0,O),p=u,await e.TrelloLists.put("lists",JSON.stringify(p))}}catch(u){console.error(u)}return{lists:p}}var gt={async fetch(t,n,e){return new C([["/",async i=>A(await q(i))],["/sw.js",R],["/lists",async i=>d(f(await V(i))),"POST"],["/lists/add",M],["/lists/cancel",()=>d(T)],["/lists/:list_id",async i=>d(f(await D(i))),"DELETE"],["/cards/move",async i=>d(f(await Q(i))),"POST"],["/cards/new/:list_id",async i=>d(f(await X(i))),"POST"],["/cards/cancel/:id",async i=>d(S(await G(i)))],["/cards/edit/:list_id/:id",async i=>d(H(await K(i)))],["/cards/:list_id/:id",async i=>d(y(await B(i))),"PUT"],["/cards/:list_id/:id",async i=>(await W(i),d("")),"DELETE"],["/cards/cancel-edit/:list_id/:id",async i=>d(y(await F(i)))]]).handle({request:t,env:n,ctx:e})},async scheduled(t,n,e){return I({event:t,env:n,ctx:e})}};export{gt as default};
