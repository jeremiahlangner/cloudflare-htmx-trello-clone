...
\`,C=at;function nt(e){let{list:t,card:i}=e;return d\`
  ...
  \`}var L=nt;function ot(e){let t=d\`\`;for(let i of e.cards)t+=d\`\${L({list:e,card:i})}\`;return t}function dt(e){let{lists:t}=e,i=d\`\`;for(let s of t)i+=d\`
    ...
    \`;return i+=d\` <div class="add-list">\${C}</div> \`,i}var h=dt;var D;function lt(e){return c(R({template:d(D||(D=y([\`
        <div class="app">
          <div class="header">
            htmx Trello Clone
        ...
        <\\/script>
      \`])),_,h(e))}))}var U=lt;function ct(){return c(d\`
