...
`,T=rn;function an(t){let{list:n,card:e}=t;return a`
  ...
  `}var y=an;function sn(t){let n=a``;for(let e of t.cards)n+=a`${y({list:t,card:e})}`;return n}function on(t){let{lists:n}=t,e=a``;for(let r of n)e+=a`
    ...
    `;return e+=a` <div class="add-list">${T}</div> `,e}var f=on;var z;function dn(t){return d(E({template:a(z||(z=k([`
        <div class="app">
        ...
        <\/script>
      `])),f(t))}))}var P=dn;function ln(){return d(a`
  ...
  `)}var H=ln;function cn(t){let{list:n,card:e}=t;return a`
